namespace System.Windows.Controls
{
    ...
    public partial class TreeViewExItem
    {
        ...
        #region Brushes Highlight
        public static DependencyProperty BackgroundHighlightProperty = DependencyProperty.Register(
                    "BackgroundHighlight",
                    typeof(Brush),
                    typeof(TreeViewExItem),
                    new FrameworkPropertyMetadata(Brushes.LightGray, null));

        public static DependencyProperty BorderHighlightProperty =
                    DependencyProperty.Register(
                    "BorderHighlight",
                    typeof(Brush),
                    typeof(TreeViewExItem),
        ...
        public Brush BackgroundHighlight
        {
            get
            {
                return (Brush)GetValue(BackgroundHighlightProperty);
            }

            set
            {
                SetValue(BackgroundHighlightProperty, value);
            }
        }
        ...
        public Brush BorderHighlight
        {
            get
            {
                return (Brush)GetValue(BorderHighlightProperty);
            }

            set
            {
                SetValue(BorderHighlightProperty, value);
            }
        }
        #endregion
        #endregion
